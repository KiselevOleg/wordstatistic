 ...
 */
package com.example.wordstatistic.user.model.remote.usingHistory;

import com.example.wordstatistic.user.util.remote.usingHistory.UsingHistoryRecordIncorrectDataException;
...
public class UsingHistoryRecord {
    ...
    /**
     * serializing to a string. (all exceptions are ignored)
     * @param usingHistoryRecord an original object
     * @return a serialized string
     */
    public static String withIngnoreExceptionsToJSON(final UsingHistoryRecord usingHistoryRecord) {
        try {
            return toJSON(usingHistoryRecord);
        } catch (JsonProcessingException | UsingHistoryRecordIncorrectDataException e) {
